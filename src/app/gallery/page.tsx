...
export default function GalleryPage() {
  ...
  const galleryImages = [
    "/images/gallary_photos/photo1.jpg?v=1",
    "/images/gallary_photos/photo2.jpg?v=1",
    "/images/gallary_photos/photo3.jpg?v=1",
    "/images/gallary_photos/photo4.jpg?v=1",
    "/images/gallary_photos/photo5.jpg?v=1",
    "/images/gallary_photos/photo6.jpg?v=1",
  ];
